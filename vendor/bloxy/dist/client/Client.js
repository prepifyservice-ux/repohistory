...
const DataStoreManager_1 = tslib_1.__importDefault(require("./lib/DataStoreManager/DataStoreManager"));
class Client extends ClientBase_1.default {
    constructor(options) {
        super(options);
        this.user = null;
        this.apis = (0, apis_1.default)(this);
        this.rest = new rest_1.default(this, this.options.rest);
        this.socket = new ClientSocket.Socket(this);
        this.dataStoreManager = new DataStoreManager_1.default(this);
    ...
    getUserIdFromUsername(username) {
        return this.apis.usersAPI.getUsersByUsernames({
            ...
            if (response.data && response.data[0]) {
                return new structures_1.PartialUser(response.data[0], this);
            }
            else {
